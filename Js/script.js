...
// Cuenta regresiva con ajuste de año automático
function showCountdown() {
  const container = document.getElementById('countdown');

  // Cambia estas fechas ⬇
  let startDate = new Date('2019-01-01T00:00:00'); // día que se conocieron
  let eventMonth = 0; // Enero → mes 0 (0-11)
  ...
  function update() {
    ...
    // Si la fecha de este año ya pasó, usar el próximo año
    if (eventDate < now) {
